<template>
    <div v-if="readonly.propertyId">
            ...
            <list-table v-if="!config.readonly" :config="{tableListConfig,queryConfig,clickHandler,form:'propertyMerchant'}" :readData="readonly" ref="tableList"></list-table>
    </div>
...
<script>
    ...
    let queryElements=[
        ...
        },
        {
            ...
            type:'select',
            placeholder:'请输入省',
            dataUrl:'/mall/community/queryProvincesByProperty.json',
            prop:'provinceId',
            initQuery:true,
            httpMethod:"post",
            defaultValue:"",
            ...
            propValueList:'data',
            noNeedAllParams:true,//propertyId
            watchParams:{propertyId:true},
            casecadeParen:"",
        ...
        },
        {
            ...
            defaultValue:"",
            placeholder:'请输入市',
            dataUrl:'/mall/community/queryCitysByProperty.json',
            prop:'cityId',
        ...
        },
        {
            ...
            type:'select',
            httpMethod:"post",
            dataUrl:'/mall/community/queryDistrictsByProperty.json',
            placeholder:'请选择区',
            prop:'districtId',
    ...
    export default {
        ...
        data(){
            return{
                ...
                readonly:{},
                tableListConfig:{},
                queryConfig:{watchProp:'propertyId'},
                chooseResult:{},
                catchListData:{}
            }
        },
        methods:{
            ...
            addItem(item,index){
                ...
                if(that.config.beforeAdd&&typeof that.config.beforeAdd == "function"){
                    ...
                    console.log("****88888888*(9999999999")
                    that.chooseResult[item.id]=item;
                    that.checkItem(item);
                    that.syncData();
                }
        ...
        created() {
            ...
            that.$watch("readonly.propertyId",function (newData,oldData) {
